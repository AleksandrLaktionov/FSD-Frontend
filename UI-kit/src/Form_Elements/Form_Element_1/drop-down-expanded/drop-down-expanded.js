export const dropDownExpanded = () => {
    ...
    const dropDownExp = document.querySelectorAll('.drop-down-expanded');
    for (let i = 0; i < dropDownExp.length; i++) {
        const _this = dropDownExp[i];

        let dropDownInput = _this.querySelector('.drop-down-input');

        let dropDownContent = _this.querySelector('.drop-down-content');
